...
import static br.com.alura.estoque.retrofit.callback.MensagensCallback.MENSAGEM_ERRO_FALHA_NA_COMUNICACAO;
...
public class BaseCallback <T> implements Callback<T> {
    ...
    public void onFailure(Call call, Throwable t) {
        callback.quandoFalha(MENSAGEM_ERRO_FALHA_NA_COMUNICACAO + t.getMessage());
    }
