...
public class EnviadorDeLanceTest {
    ...
    @Test
    public void deve_MostrarMensagemDeFalha_QuandoLanceFormMenorQueUltimoLance(){
        final EnviadorDeLance enviador = new EnviadorDeLance(
                cliente,
                listener,
                contexto,
                manager);
        ...
        Mockito.verify(manager).mostraAvisoLanceMenorQueUltimoLance(contexto);
    }
    ...
    public void deve_MostrarMensagemDeFalha_QuandoUsuarioComCincoLancesDerNovoLance(){
        ...
        Mockito.verify(manager).mostraAvisoUsuarioJaDeuCincoLances(contexto);
    }
